...
\begin{definition}[Construction of GNBA from LTL{\cite[p.~274, def.~5.33]{baier2008principles}}]
...
\begin{definition}[Construction of NBA from GNBA{\cite[p.~278, thm.~5.37]{baier2008principles}}]
